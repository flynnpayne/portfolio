    ...
    return (
        <div name='skills' className='w-full h-screen bg-primary-color text-text-color dark:bg-dark-primary-color dark:text-dark-text-color'>
            <div className='max-w-[1000px] mx-auto px-4 sm:px-8 flex flex-col justify-center h-full'>
                ...
                <div className='w-full flex justify-center flex-wrap text-center py-8'>
                    <div className='bg-secondary-color dark:bg-dark-secondary-color rounded-md shadow-lg mt-4 w-full sm:hover:scale-105 duration-500 sm:m-4 sm:w-[15rem]'>
